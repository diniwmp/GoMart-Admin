...
if (!title) {
    showAlert("Please enter product title.", "error");
    return;
}
...
if (isNaN(stockCount) || stockCount < 0) {
    showAlert("Please enter valid stock count.", "error");
    return;
}
if (!file1) {
    showAlert("Please select image 1.", "error");
    return;
}
if (!file2) {
    showAlert("Please select image 2.", "error");
    return;
}
