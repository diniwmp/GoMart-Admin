...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .form-control:focus { border-color: #22c55e; box-shadow: 0 0 0 3px #22c55e20; outline: none; }
    ...
    .category-img { width: 52px; height: 52px; object-fit: cover; border-radius: 10px; border: 1px solid #e2e8f0; }
    .category-name { font-weight: 500; color: #1a2332; }
