...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .customer-name { font-weight: 500; color: #1a2332; }
    .customer-email { font-size: 11px; color: #94a3b8; }
    .order-amount { font-weight: 600; color: #1a2332; }
    ...
    .btn-view { background: #f8fafc; color: #475569; border: 1px solid #e2e8f0; border-radius: 6px; padding: 5px 12px; font-size: 12px; font-weight: 500; cursor: pointer; }
    .btn-view:hover { background: #f1f5f9; }

    .status-select { font-size: 12px; border: 1px solid #e2e8f0; border-radius: 6px; padding: 4px 8px; color: #1a2332; outline: none; cursor: pointer; }
    .status-select:focus { border-color: #22c55e; }
    ...
    .modal-box { background: #fff; border-radius: 14px; padding: 28px; width: 100%; max-width: 560px; max-height: 85vh; overflow-y: auto; }
    ...
    .detail-section-title { font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 10px; font-weight: 500; }
    ...
    .item-row { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid #f8fafc; font-size: 13px; }
    .item-row:last-child { border-bottom: none; }
    .item-name { color: #1a2332; font-weight: 500; }
    .item-qty { color: #94a3b8; font-size: 12px; }
    .item-price { color: #1a2332; font-weight: 600; }
