...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .section-divider { font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em; margin: 20px 0 12px; padding-bottom: 6px; border-bottom: 1px solid #f1f5f9; }

    .form-label { font-size: 12px; color: #64748b; margin-bottom: 5px; display: block; }
    .form-control, .form-select { font-size: 13px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 9px 12px; width: 100%; outline: none; }
    .form-control:focus, .form-select:focus { border-color: #22c55e; box-shadow: 0 0 0 3px #22c55e20; }
    textarea.form-control { resize: vertical; min-height: 80px; }

    .img-preview-row { display: flex; gap: 12px; margin-top: 10px; }
    .img-preview-box { width: 80px; height: 80px; border-radius: 10px; border: 1px dashed #e2e8f0; display: flex; align-items: center; justify-content: center; overflow: hidden; background: #f8fafc; }
    .img-preview-box img { width: 100%; height: 100%; object-fit: cover; border-radius: 10px; display: none; }
    .img-preview-label { font-size: 10px; color: #94a3b8; text-align: center; }
    ...
    .progress-bar-bg { background: #f1f5f9; border-radius: 4px; height: 6px; }
    .progress-bar-fill { background: #22c55e; height: 6px; border-radius: 4px; width: 0%; transition: width 0.3s; }
    .progress-label { font-size: 11px; color: #64748b; margin-top: 4px; }

    .alert-msg { font-size: 13px; padding: 10px 14px; border-radius: 8px; margin-top: 14px; display: none; }
    .alert-success { background: #d1fae5; color: #065f46; }
    .alert-error { background: #fee2e2; color: #991b1b; }

    .btn-add { background: #22c55e; color: #fff; border: none; border-radius: 8px; padding: 10px 28px; font-size: 13px; font-weight: 500; cursor: pointer; }
    ...
    .table td { font-size: 13px; color: #1a2332; vertical-align: middle; border-bottom: 1px solid #f8fafc; padding: 10px 12px; }
    .product-img { width: 48px; height: 48px; object-fit: cover; border-radius: 8px; border: 1px solid #e2e8f0; }
    .product-title { font-weight: 500; color: #1a2332; }
    .product-sub { font-size: 11px; color: #94a3b8; }
    ...
    .btn-edit { background: #eff6ff; color: #1e40af; border: 1px solid #bfdbfe; border-radius: 6px; padding: 5px 12px; font-size: 12px; font-weight: 500; cursor: pointer; }
    .btn-edit:hover { background: #dbeafe; }
    .btn-delete { background: #fff1f2; color: #991b1b; border: 1px solid #fecaca; border-radius: 6px; padding: 5px 12px; font-size: 12px; font-weight: 500; cursor: pointer; margin-left: 6px; }
    ...
    .modal-overlay { display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.4); z-index: 999; align-items: flex-start; justify-content: center; padding: 30px 0; overflow-y: auto; }
    .modal-overlay.show { display: flex; }
    .modal-box { background: #fff; border-radius: 14px; padding: 28px; width: 100%; max-width: 600px; margin: auto; }
    .modal-title { font-size: 16px; font-weight: 600; color: #1a2332; margin-bottom: 20px; }
    .modal-actions { display: flex; gap: 10px; margin-top: 24px; }
    .btn-cancel { flex: 1; background: #f1f5f9; color: #475569; border: none; border-radius: 8px; padding: 10px; font-size: 13px; cursor: pointer; }
    .btn-save { flex: 1; background: #22c55e; color: #fff; border: none; border-radius: 8px; padding: 10px; font-size: 13px; font-weight: 500; cursor: pointer; }
