...
<html>
<head>
  <title>GoMart Admin - Brands</title>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .form-label { font-size: 12px; color: #64748b; margin-bottom: 5px; }
    .form-control { font-size: 13px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 9px 12px; }
    .form-control:focus { border-color: #22c55e; box-shadow: 0 0 0 3px #22c55e20; }

    .btn-add { background: #22c55e; color: #fff; border: none; border-radius: 8px; padding: 9px 20px; font-size: 13px; font-weight: 500; cursor: pointer; width: 100%; }
    ...
    .brand-img { width: 52px; height: 52px; object-fit: cover; border-radius: 10px; border: 1px solid #e2e8f0; }
    .brand-name { font-weight: 500; color: #1a2332; }
    ...
    .modal-box { background: #fff; border-radius: 14px; padding: 28px; width: 100%; max-width: 400px; }
    .modal-title { font-size: 16px; font-weight: 600; color: #1a2332; margin-bottom: 18px; }
    .modal-actions { display: flex; gap: 10px; margin-top: 20px; }
    .btn-cancel { flex: 1; background: #f1f5f9; color: #475569; border: none; border-radius: 8px; padding: 9px; font-size: 13px; cursor: pointer; }
    .btn-save { flex: 1; background: #22c55e; color: #fff; border: none; border-radius: 8px; padding: 9px; font-size: 13px; font-weight: 500; cursor: pointer; }
...
<div class="sidebar">
  ...
  <a href="brand.jsp" class="active">&#9674; Brands</a>
...
<div class="main-content">
  ...
  <div class="content-card">
    ...
    <div class="row g-3">
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="brandName" placeholder="e.g. Maliban">
      </div>
      <div class="col-md-4">
        <label class="form-label">Brand Image</label>
        <input type="file" class="form-control" id="brandImage" accept="image/*">
      </div>
      <div class="col-md-4 d-flex align-items-end">
        <button class="btn-add" id="addBtn" onclick="addBrand()">+ Add Brand</button>
      </div>
    </div>
  ...
  <div class="content-card">
    ...
    <table class="table table-borderless mb-0">
      ...
      <tbody id="brandTable">
        <tr><td colspan="4" class="loading">Loading brands...</td></tr>
      </tbody>
    </table>
  </div>
...
<div class="modal-overlay" id="editModal">
  <div class="modal-box">
    ...
    <div class="mb-3">
      ...
      <input type="file" class="form-control" id="editBrandImage" accept="image/*">
    </div>
