...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .customer-avatar { width: 38px; height: 38px; border-radius: 50%; object-fit: cover; border: 1px solid #e2e8f0; }
    .customer-avatar-placeholder { width: 38px; height: 38px; border-radius: 50%; background: #22c55e20; display: flex; align-items: center; justify-content: center; font-size: 13px; font-weight: 600; color: #22c55e; }
    .customer-name { font-weight: 500; color: #1a2332; }
    .customer-email { font-size: 11px; color: #94a3b8; }
    .customer-uid { font-size: 11px; color: #94a3b8; font-family: monospace; }

    .btn-view { background: #f8fafc; color: #475569; border: 1px solid #e2e8f0; border-radius: 6px; padding: 5px 12px; font-size: 12px; cursor: pointer; }
    ...
    .customer-profile { display: flex; align-items: center; gap: 16px; margin-bottom: 24px; padding-bottom: 20px; border-bottom: 1px solid #f1f5f9; }
    .profile-avatar { width: 64px; height: 64px; border-radius: 50%; object-fit: cover; border: 2px solid #e2e8f0; }
    .profile-avatar-placeholder { width: 64px; height: 64px; border-radius: 50%; background: #22c55e20; display: flex; align-items: center; justify-content: center; font-size: 22px; font-weight: 600; color: #22c55e; }
    .profile-name { font-size: 16px; font-weight: 600; color: #1a2332; }
...
<div class="sidebar">
  ...
  <a href="customers.jsp" class="active">&#9689; Customers</a>
...
<div class="main-content">
  ...
  <div class="content-card">
    <div class="card-title">All Customers
      <span id="customerCount" style="font-size:12px;color:#94a3b8;font-weight:400"></span>
    </div>
...
<div class="modal-overlay" id="customerModal">
  <div class="modal-box">
    ...
    <div class="detail-row"><span class="detail-label">User ID</span><span class="detail-value" id="modalUid" style="font-size:11px;font-family:monospace">—</span></div>
