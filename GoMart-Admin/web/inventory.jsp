...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .product-id { font-size: 11px; color: #94a3b8; }
    .product-img { width: 44px; height: 44px; object-fit: cover; border-radius: 8px; border: 1px solid #e2e8f0; }

    .stock-bar-bg { width: 100px; height: 6px; background: #f1f5f9; border-radius: 3px; overflow: hidden; display: inline-block; vertical-align: middle; margin-right: 8px; }
    .stock-bar-fill { height: 100%; border-radius: 3px; }
    .stock-qty { font-size: 13px; font-weight: 600; vertical-align: middle; }

    .status-badge { font-size: 10px; padding: 4px 10px; border-radius: 20px; font-weight: 600; }
    .s-in-stock { background: #d1fae5; color: #065f46; }
    .s-low-stock { background: #fef3c7; color: #92400e; }
    .s-out-stock { background: #fee2e2; color: #991b1b; }

    .btn-update { background: #eff6ff; color: #1e40af; border: 1px solid #bfdbfe; border-radius: 6px; padding: 5px 12px; font-size: 12px; font-weight: 500; cursor: pointer; }
    ...
    .modal-title { font-size: 16px; font-weight: 600; color: #1a2332; margin-bottom: 6px; }
    ...
    .form-control { font-size: 13px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 9px 12px; width: 100%; outline: none; }
