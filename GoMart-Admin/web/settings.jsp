...
<head>
  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .admin-avatar-top { width: 28px; height: 28px; border-radius: 50%; background: #22c55e20; display: flex; align-items: center; justify-content: center; font-size: 11px; font-weight: 600; color: #22c55e; overflow: hidden; }
    .admin-avatar-top img { width: 100%; height: 100%; object-fit: cover; }
    .admin-name { font-size: 12px; font-weight: 500; color: #1a2332; }

    .settings-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
    .settings-grid-full { grid-column: 1 / -1; }

    .content-card { background: #fff; border-radius: 14px; border: 1px solid #e2e8f0; padding: 24px; margin-bottom: 0; }
    .card-title { font-size: 15px; font-weight: 600; color: #1a2332; margin-bottom: 4px; }
    ...
    .form-control { font-size: 13px; border: 1px solid #e2e8f0; border-radius: 8px; padding: 9px 12px; width: 100%; outline: none; background: #fff; color: #1a2332; }
    .form-control:focus { border-color: #22c55e; box-shadow: 0 0 0 3px #22c55e20; }
    .form-control:disabled { background: #f8fafc; color: #94a3b8; }

    /* Profile picture */
    .profile-pic-wrap { display: flex; align-items: center; gap: 20px; margin-bottom: 20px; }
    .profile-pic-circle { width: 80px; height: 80px; border-radius: 50%; border: 2px solid #e2e8f0; overflow: hidden; background: #22c55e20; display: flex; align-items: center; justify-content: center; font-size: 28px; font-weight: 600; color: #22c55e; flex-shrink: 0; cursor: pointer; position: relative; }
    .profile-pic-circle img { width: 100%; height: 100%; object-fit: cover; display: none; }
    .profile-pic-overlay { position: absolute; bottom: 0; left: 0; right: 0; background: rgba(0,0,0,0.4); color: #fff; font-size: 9px; text-align: center; padding: 3px 0; }
    .profile-pic-input { display: none; }
    .profile-pic-info { font-size: 12px; color: #64748b; }
    .profile-pic-info span { display: block; font-size: 11px; color: #94a3b8; margin-top: 3px; }

    /* Progress bar */
    .progress-bar-wrap { display: none; margin-top: 8px; }
    .progress-bar-bg { background: #f1f5f9; border-radius: 4px; height: 5px; }
    .progress-bar-fill { background: #22c55e; height: 5px; border-radius: 4px; width: 0%; transition: width 0.3s; }
    .progress-label { font-size: 11px; color: #64748b; margin-top: 3px; }

    /* Buttons */
    .btn-save { background: #22c55e; color: #fff; border: none; border-radius: 8px; padding: 9px 22px; font-size: 13px; font-weight: 500; cursor: pointer; }
    .btn-save:hover { background: #16a34a; }
    .btn-save:disabled { background: #86efac; cursor: not-allowed; }
    .btn-danger { background: #fee2e2; color: #991b1b; border: 1px solid #fecaca; border-radius: 8px; padding: 9px 22px; font-size: 13px; font-weight: 500; cursor: pointer; }
    .btn-danger:hover { background: #fecaca; }

    /* Alert */
    .alert-msg { font-size: 13px; padding: 9px 14px; border-radius: 8px; margin-top: 14px; display: none; }
    .alert-success { background: #d1fae5; color: #065f46; }
    .alert-error { background: #fee2e2; color: #991b1b; }

    /* About card */
    .about-row { display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid #f8fafc; font-size: 13px; }
    .about-row:last-child { border-bottom: none; }
    .about-label { color: #64748b; }
    .about-value { color: #1a2332; font-weight: 500; }
    .about-badge { background: #d1fae5; color: #065f46; font-size: 11px; padding: 3px 10px; border-radius: 20px; font-weight: 600; }

    /* Password strength */
    .strength-bar { display: flex; gap: 4px; margin-top: 6px; }
    .strength-seg { height: 4px; flex: 1; border-radius: 2px; background: #f1f5f9; transition: background 0.3s; }
